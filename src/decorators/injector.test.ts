...
import { Inject, Injectable, Injector } from './injector';
...
describe('injector', () => {
  ...
  it('should auto generate instance with @Injectable()', () => {
    @Injectable()
    class DEF {
      username: string = 'DEF';
      hello() {
  ...
  it('should auto generate instance properties with @Inject()', () => {
    @Injectable()
    class GHI {
      get name() {
        return 'GHI';
